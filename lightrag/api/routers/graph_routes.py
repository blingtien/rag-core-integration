...
def create_graph_routes(rag, api_key: Optional[str] = None, max_graph_nodes: int = 1000):
    ...
    async def get_knowledge_graph(
        ...
        max_nodes: int = Query(max_graph_nodes, description="Maximum nodes to return", ge=1),
    ):
        """
